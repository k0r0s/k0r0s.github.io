...
Se puede intuir la dirección que puede tomar integración de IA en vías de obtener mayor control sobre el mercado "_white collar_" y "_petite bourgeoisie_" (maquinismo de Marx) - que no han temido a una fuerza como la automatización, tal y como lo fue para los empleos "_blue collar_"- desde el materialismo histórico y los <font color = "#1ce7ad">ciclos de lucha</font> de Mario Tronti en la línea del autonomismo italiano. 
